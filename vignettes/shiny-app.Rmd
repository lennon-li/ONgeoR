...
```{r screenshot-link-tab, echo=FALSE, out.width="100%", fig.cap="The Link tab at startup. Source and Target layer pickers are set to their defaults; the Join button is greyed out until a preview succeeds."}
knitr::include_graphics("../man/figures/app-link-tab.png")
```

The app has a single working tab. It retrieves two registered Ontario GeoHub or
LIO layers and joins them spatially.
