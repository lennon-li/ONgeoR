...
- Draws interactive leaflet maps with `map_layers()` and nearest-match maps
  with `map_nearest()`
- A point-and-click Shiny app is provided by the companion package [ONgeoRapp](https://github.com/lennon-li/ONgeoRapp)
...
[**ONgeoRapp**](https://github.com/lennon-li/ONgeoRapp). It is running live at
