...
4. **Join** -- Click **Join** to open a confirmation that names both layers
   with their dimensions and states the expected result shape, e.g. "11,625
   rows x 14 columns -- one row per target feature". Nothing is retrieved or
   computed until you confirm. For the "Any overlap" and "Apportion across
   overlaps" rules the result can be longer than the target layer, because
   both keep every overlap; the confirmation says so.
