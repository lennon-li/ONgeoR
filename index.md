...
homes, incidents, postal codes – and resolves them to the geography your
work actually reports on: Public Health Units, Ontario Health Regions,
municipalities, census areas. It fetches the boundaries live from
authoritative services, does the spatial join, and hands back a table
...
reads the geometry pair and chooses.
[`link()`](https://lennon-li.github.io/ONgeoR/reference/link.md) and
[`nearest()`](https://lennon-li.github.io/ONgeoR/reference/nearest.md)
are there when you want to be explicit, and
[`build_crosswalk()`](https://lennon-li.github.io/ONgeoR/reference/build_crosswalk.md)
emits weighted apportionment with provenance attached.

**Interactive maps, not just static plots.**
...
produce Leaflet widgets you can pan, zoom, and hand to someone who does
not use R.
...
- Retrieves 2021 Statistics Canada census cartographic boundaries with
  ...
  filtered to Ontario server-side, with optional bounding-box narrowing
  for the finer geographies
